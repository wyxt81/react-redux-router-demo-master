...
class ChartScatter extends Component {
    ...
    convertOption = (props) => {
        ...
        let legend = {
            ...
            data: (props.legend && props.xAxis.length !== 0) ? props.legend : ['女性', '男性'],
            top: '9',
        };
        let xAxis = {
            type: 'value',
            ...
            axisLabel: {
                formatter: function(value, index){
                    if(parseFloat(value) > 10000){
                        value = parseFloat(value / 10000) + "万" + (style.xunit || "");
                    } else {
                        value = value + (style.xunit || "");
                    }
                    return value;
                },
                textStyle: {
        ...
        if(props.series && props.series.length !== 0){
            series = props.series.map(function (item, index) {
                return {
                    ...
                    type: 'scatter',
                    data: item.array,
                    yAxisIndex: yAxisObject[legend[index]] || 0,
                }
            });
        }
        return {
